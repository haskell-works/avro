...
deconflictTwoUnions :: NonEmpty Type -> T.LazyValue Type -> T.LazyValue Type
...
deconflictWriterUnion :: Type -> T.LazyValue Type -> T.LazyValue Type
...
deconflictRecord writerSchema readerSchema (T.Record ty fldVals)  =
  T.Record ty . HashMap.fromList $ fmap (deconflictFields fldVals (fields writerSchema)) (fields readerSchema)
